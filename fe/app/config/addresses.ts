...
export const ADDRESSES = {
  victoryCrate: (process.env.NEXT_PUBLIC_VICTORY_CRATE_ADDRESS ||
    "0xB0db5f8fC40fb199Db8597c68feceFa586088CbE") as `0x${string}`,

  tarikVault: (process.env.NEXT_PUBLIC_TARIK_VAULT_ADDRESS ||
    "0x6604f0429E9f9FE0b57Ae0F0167E2caE2c5f2cc3") as `0x${string}`,
} as const;
